...
public class CaldroidFragment extends DialogFragment {
	...
	protected void refreshMonthTitleTextView() {
		...
		String parts[] = monthTitle.split(" ");
		Map<String, String> meseci = this.getSerbianMonths();
		String replaced = monthTitle.replace(parts[0], meseci.get(parts[0]));
		
		monthTitleTextView.setText(replaced);
	}
	
	protected Map<String, String> getSerbianMonths()
	{
		Map<String, String> meseci = new HashMap<String, String>();
		meseci.put("January", "Januar");
		meseci.put("February", "Februar");
		meseci.put("March", "Mart");
		meseci.put("April", "April");
		meseci.put("May", "Maj");
		meseci.put("June", "Jun");
		meseci.put("July", "Jul");
		meseci.put("August", "Avgust");
		meseci.put("September", "Septembar");
		meseci.put("October", "Oktobar");
		meseci.put("November", "Novembar");
		meseci.put("December", "Decembar");
	...
	protected ArrayList<String> getDaysOfWeek() {
		...
		Map<String, String> dani = this.getSerbianDays();
		
		for (int i = 0; i < 7; i++) {
			Date date = CalendarHelper.convertDateTimeToDate(nextDay);
			list.add(dani.get(fmt.format(date).toUpperCase()));
	...
	protected Map<String, String> getSerbianDays()
	{
